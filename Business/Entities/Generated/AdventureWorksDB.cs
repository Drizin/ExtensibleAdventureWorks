...
//     Connection String:      "Data Source=(local);Initial Catalog=AdventureWorks2012;Persist Security Info=True;User ID=adventureworks;password=**zapped**;;MultipleActiveResultSets=True"
// ------------------------------------------------------------------------------------------------
...
namespace ExtensibleAdventureWorks.Business.Entities
{
    ...
    public partial class AdventureWorksDB : System.Data.Entity.DbContext, IAdventureWorksDB
    {
        ...
        static AdventureWorksDB()
        {
            ...
            AdventureWorksDBStaticPartial(); // Create the following method in your partial class: private static void AdventureWorksDBStaticPartial() { }
        }
        ...
        public AdventureWorksDB(string connectionString)
            : base(connectionString)
        {
            InitializePartial();
        }

        public AdventureWorksDB(string connectionString, System.Data.Entity.Infrastructure.DbCompiledModel model)
            : base(connectionString, model)
        {
            InitializePartial();
        }

        public AdventureWorksDB(System.Data.Common.DbConnection existingConnection, bool contextOwnsConnection)
            : base(existingConnection, contextOwnsConnection)
        {
            InitializePartial();
        }

        public AdventureWorksDB(System.Data.Common.DbConnection existingConnection, System.Data.Entity.Infrastructure.DbCompiledModel model, bool contextOwnsConnection)
